...
DeviceType(slug="poweredge-t620", manufacturer_id=manufacturer_id).save()

DeviceType = DeviceType.objects.get(slug="poweredge-t620")
DeviceType.model="PowerEdge T620"
