...
DeviceType(slug="poweredge-r820", manufacturer_id=manufacturer_id).save()

DeviceType = DeviceType.objects.get(slug="poweredge-r820")
DeviceType.model="PowerEdge R820"
