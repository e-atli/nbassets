...
DeviceType(slug="poweredge-r620", manufacturer_id=manufacturer_id).save()

DeviceType = DeviceType.objects.get(slug="poweredge-r620")
DeviceType.model="PowerEdge R620"
