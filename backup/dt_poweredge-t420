...
DeviceType(slug="poweredge-t420", manufacturer_id=manufacturer_id).save()

DeviceType = DeviceType.objects.get(slug="poweredge-t420")
DeviceType.model="PowerEdge T420"
